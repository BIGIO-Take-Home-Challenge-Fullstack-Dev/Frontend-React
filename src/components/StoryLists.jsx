    ...
    <div className="container mt-5">
      <div className="columns">
        <div className="column is-centered">
          <h2 className="title">List Story</h2>
          <Link to="/story/add" className="button is-primary mb-2 mr-2">
            Add New
          </Link>
          <button className="button mb-2 is-rounded" onClick={showModal}>
            ...
            <div className="modal is-active">
              ...
              <div className="modal-card">
                ...
                <footer className="modal-card-foot">
                  <button className="button is-success" onClick={hideModal}>
                    Filter
                  </button>
                  <button
