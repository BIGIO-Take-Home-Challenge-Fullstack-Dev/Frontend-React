...
const AddStory = () => {
  ...
  const saveStory = async (e) => {
    ...
    try {
      await axios.post("http://localhost:5000/story", formData, {
        headers: {
      ...
      <div className="column is-four-fifths">
        ...
        <form onSubmit={saveStory}>
          ...
          <table className="table is-striped is-fullwidth mt-5 has-text-centered">
            ...
            <tbody>
              {chapters.length === 0 ? (
                <tr>
                  <td colSpan="6">
                    Tidak terdapat data Chapter yang tersimpan
                  </td>
                </tr>
              ) : (
          ...
          <div className="field is-grouped">
            ...
            <div className="control">
              <Link className="button is-danger" onClick={showModal}>
                Cancel
              </Link>
              {isModalVisible && (
                <div className="modal is-active">
                  ...
                  <div className="modal-card">
                    <section className="modal-card-body">
                      <h1>Are you sure you want to cancel adding the story without saving the data?</h1>
                    </section>
